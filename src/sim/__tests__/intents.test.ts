...
describe('starting activities', () => {
  ...
  it('goes to an action that is somewhere else, and starts it there', () => {
    // Scavenging is out in the world. There is no journey to sit through any more, so
    // the order and the arrival are the same event.
  ...
  it('stops when told, leaving you where you stood', () => {
    let state = startSkillAction(newGame(), 'scavenging', 'roadside_wrecks')
